...
This journey, from a complex stochastic model of individual cars and intersections to a simple, elegant closed-form solution, showcases the power of theoretical modeling. By starting with a discrete world, abstracting it into a continuous one, and making a physically motivated mean-field assumption, we were able to derive a continuous model that accurately captures the long-term behavior of the entire traffic system. 
